...
<main style="opacity: 1;" class="">
    <div class="js-stage stage texture">
        <div style="opacity: 1; transform: translateZ(-200px) translateY(0px);"
...
.p1 {
    top: 420px;left: 410px;
}
.p2 {
    top: 350px;left: 180px;
}
.p3 {
    top: 350px;left: 320px;
}
.p4 {
    top: 350px;left: 490px;
}
.p5 {
